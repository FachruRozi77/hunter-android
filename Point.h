...
// Batched version: computes `count` public keys at once with single batch inversion
...
with open('/mnt/agents/output/SECP256K1.h', 'w') as f:
    f.write(secp_h_content)

print("SECP256K1.h written successfully")

# Now create the remaining unchanged files
point_h_content = r'''/*
