...
//----------------------------------------------------------------------------
// ARM64-OPTIMIZED ADDITION using ADC chain
// Uses ADDS + ADC for optimal carry propagation on ARM64
//----------------------------------------------------------------------------
void Int::Add(Int *a) {
...
//----------------------------------------------------------------------------
// ARM64-OPTIMIZED SUBTRACTION using SBC chain
// Uses SUBS + SBC for optimal borrow propagation on ARM64
//----------------------------------------------------------------------------
void Int::Sub(Int *a) {
...
//----------------------------------------------------------------------------
// ARM64-OPTIMIZED MULTIPLICATION using MADD/UMULH
// Replaces separate multiply+add with fused MADD operations
//----------------------------------------------------------------------------
